...
clickCount = id => {
  ...
  render() {
    return (
      <Wrapper>
        <Title message={this.state.message} score={this.state.score} highscore={this.state.highscore}>Clicky Game - Pick a card, but don't pick the same one twice</Title>
